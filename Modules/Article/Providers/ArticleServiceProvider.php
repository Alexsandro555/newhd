...
use Modules\Article\Observers\TabsObserver;
...
class ArticleServiceProvider extends ServiceProvider
{
  ...
  public function register()
  {
    ...
    $this->app->bind('ArticleType', function ($app) {
      return new ArticleType();
    });
    $this->app->bind('OtherArticle', function ($app) {
      return new OtherArticle();
    });

    Article::observe(TabsObserver::class);
  }
