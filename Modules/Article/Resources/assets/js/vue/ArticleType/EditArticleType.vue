...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapState('article_types', ['items', 'fields', 'relations', 'typeFiles']),
            ...mapGetters('article_types', {getItem: GLOBAL.GET_ITEM, getModel: 'getModel'}),
            form() {
                return _.pick(this.getItem(Number(this.id)), ['id','title', 'sort', 'active'])
            }
        },
        components: {
            formBuilder,
